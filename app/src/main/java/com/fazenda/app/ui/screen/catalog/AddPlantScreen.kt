            ...
            Surface(
                ...
                Column(modifier = Modifier.padding(12.dp)) {
                    ...
                    Button(
                            ...
                            if (query.isNotBlank()) {
                                ...
                                scope.launch {
                                    try {
                                        ...
                                        if (result != null) {
                                            if (nameText.isBlank()) nameText = result.title
                                            if (categorySearchText.isNotBlank() && result.description.isNotBlank() && selectedCategoryId == null) {
                                                categorySearchText = result.description
                        ...
                        Text(if (isFetchingInfo) "Завантаження..." else "Заповнити з Wikipedia")
                    }
